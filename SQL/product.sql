...
INSERT INTO `product` (`p_Id`, `p_Account`, `p_Name`, `c_Id`, `p_Title`, `p_Des`, `p_originalPrice`, `p_Price`, `p_Date`, `p_href`, `p_num`) VALUES (72, 'user3', '体育健身-球类', 'c05', '迪士尼篮球儿童', '3号幼儿园小学生比赛专用耐磨橡胶高弹训练5号篮球', 36, 16, '2021-07-13', '/images/product/72.png', 1);
