...
public interface OrderMapper {
    ...
    @Select("select o.o_Id, p.p_href, p.p_Price, p.p_Title, o.o_Buyer, o.o_Seller, o.o_Baddress, o.o_ItemId, o.o_Status, o.o_ExpressId from order2 o, product p where o_ItemId = p.p_Id and o.o_Buyer = #{0}")
    ...
    @Select("select o.o_Id, p.p_href, p.p_Price, p.p_Title, o.o_Buyer, o.o_Seller, o.o_Baddress, o.o_ItemId, o.o_Status, o.o_ExpressId from order2 o, product p where o_ItemId = p.p_Id and o.o_Seller = #{0}")
    ...
    @Select("select o.o_Id, p.p_href, p.p_Price, p.p_Title, o.o_Buyer, o.o_Seller, o.o_Baddress,o.o_Saddress,o.o_Date, o.o_ItemId, o.o_Status, o.o_ExpressId from order2 o, product p where o_ItemId = p.p_Id and o.o_Seller like #{0}")
    ...
    @Select("select o.o_Id, p.p_href, p.p_Price, p.p_Title, o.o_Buyer, o.o_Seller, o.o_Baddress,o.o_Saddress, o.o_Date,o.o_ItemId, o.o_Status, o.o_ExpressId from order2 o, product p where o_ItemId = p.p_Id")
